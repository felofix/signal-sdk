import { Mandate, generateBook, paymentsEnvironment } from "../src/environments/payments/index.js";
...
export async function fixtures() {
  cached ??= (async () => {
    ...
    return measure([new FunctionImplementation(demoDefinition(), reconcile, "simulation")], distribution, scenarios,
      { environment: paymentsEnvironment(demoMandate(scenarios)), config: new MeasurementConfig({ repetitions: 2, bootstrapSamples: 200, lossSimulations: 200 }) });
  })();
